...
class FavouritesControllerTest < ActionController::TestCase
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post :create, favourite: { amount: @favourite.amount, budget_id: @favourite.budget_id, description: @favourite.description, title: @favourite.title, user_id: @favourite.user_id }
    end
  ...
  test "should update favourite" do
    put :update, id: @favourite, favourite: { amount: @favourite.amount, budget_id: @favourite.budget_id, description: @favourite.description, title: @favourite.title, user_id: @favourite.user_id }
    assert_redirected_to favourite_path(assigns(:favourite))
  end
